...
public class SearchProduct extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categories1.add("Bluetooth Speaker");
        categories1.add("Iron Box");
        categories1.add("PS4");
        categories1.add("Head Phone");
        // Creating adapter for spinner
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        int imageResource = getResources().getIdentifier("@drawable/floorps4", null, getPackageName());
        Drawable graph_background = getResources().getDrawable(imageResource);


        int imageResource1 = getResources().getIdentifier("@drawable/floorbluetoothspeaker", null, getPackageName());
        Drawable graph_background1 = getResources().getDrawable(imageResource1);

        int imageResource2 = getResources().getIdentifier("@drawable/floorheadphones", null, getPackageName());
        Drawable graph_background2 = getResources().getDrawable(imageResource2);

        int imageResource3 = getResources().getIdentifier("@drawable/floorironbox", null, getPackageName());
        ...
        switch(item+"&"+item1){
            ...
            case "Staricase1&Bluetooth Speaker":
            ...
            case "Staricase2&Bluetooth Speaker":
                graph.setBackground(graph_background1);
